...
public class LocationUpdate extends com.jsoniter.spi.EmptyEncoder {
    public void encode(Object obj, com.jsoniter.output.JsonStream stream) throws java.io.IOException {
        ...
        stream.write((byte) '{');
        encode_((io.github.volyx.ratpack.update.LocationUpdate) obj, stream);
        stream.write((byte) '}');
    }

    public static void encode_(io.github.volyx.ratpack.update.LocationUpdate obj, com.jsoniter.output.JsonStream stream) throws java.io.IOException {
